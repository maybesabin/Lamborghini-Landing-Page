...
import image3 from '../assets/aventador.png'

const frontpage = () => {

    return (
        <div id='page3' className='overflow-hidden relative w-full h-full flex items-center justify-center'>
            <div className='w-[90rem] flex items-center justify-start relative h-full'>
                <div className={`absolute top-50 left-50 z-[992] w-full flex items-center justify-center`}>
                    <img className='image h-full object-cover w-full bg-transparent' src={image3} alt="" />
                </div>
                ...
                <div className='ml-[-3rem] flex flex-col items-start justify-center gap-6 mt-[-15rem] z-[991] w-[400px] text-zinc-400'>
                    <p>
                        The Aventador represents Lamborghini’s flagship V12-powered supercar, showcasing cutting-edge performance and unmistakable design.
